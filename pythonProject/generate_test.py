...
# 从txt文件中读取数据包长度分布
length_distribution = {}
with open('E:\\tyy_confuse\\Pcaps\\audio_test\\Audio_packet_lengths_test.txt', 'r', encoding='utf-16') as f:
    for line in f:
...
with open("Audio_test_data.json", "w") as f:
    json.dump(training_data, f, indent=4)

print("训练集已保存到 Audio_test_data.json 文件中。")
